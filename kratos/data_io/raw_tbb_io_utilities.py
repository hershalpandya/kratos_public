##ON APP MACHINE
""" A lot of this we won't need, or want to do differently. But raw_tbb_IO depends on it for now... """
...
latlonCS002 = np.array(
    [52.91512249, 6.869837540]
)  ## lattitude and longitude of CS002 in degrees
